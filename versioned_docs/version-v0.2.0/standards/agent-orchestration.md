...
*(Required for ≡ƒö┤-risk issues and issues labeled `st/archetype` or `st/leverage-point`. Recommended for ≡ƒƒí. Optional for ≡ƒƒó.)*
...
**Systems Thinking (ST) is the analytical lens for every domain.** Before proposing solutions, the principal agent analyzes the structural dynamics of the issue ΓÇö what stocks are affected, what flows change, which feedback loops operate, and where the highest-leverage intervention lies.

This analysis is **not optional for ≡ƒö┤-risk issues**. It is recommended for all ≡ƒƒí issues and optional for ≡ƒƒó.

See [docs/standards/systems-thinking.md](systems-thinking.md) for the full ST reference.

### ST step in the Assessment Comment

The Assessment Comment template now includes a **≡ƒöä Systems Analysis** section after **Recommended Tools / Services**:
...
### Updated Domain ΓåÆ Agent Mapping (v0.2.0)
...
|--------|----------------|-------------------|-----------|----------|
| Governance / Architecture | Anvil | ΓÇö | ≡ƒƒí | Full analysis required |
| Infrastructure / DevOps | Anvil | DevOps agent | ≡ƒƒí | Stocks: reliability, tech debt |
| IT / Workspace | Anvil | IT support agent | ≡ƒƒó | Optional |
| Branching / Versioning | Anvil | ΓÇö | ≡ƒƒó | Optional |
| Finance / Accounts | Anvil (coordinator) | Finance modeling agent + human review | ≡ƒö┤ | Required ΓÇö cash stocks, flows |
| Billing | Anvil (coordinator) | Billing agent + human review | ≡ƒö┤ | Required ΓÇö revenue flows |
| Payments | Anvil (coordinator) | Payments agent + human review | ≡ƒö┤ | Required ΓÇö transaction stocks |
| Legal / Compliance | Anvil (coordinator) | Legal review agent + human review | ≡ƒö┤ | Required ΓÇö risk stocks |
| HR | Anvil (coordinator) | HR/business process agent | ≡ƒƒí | Recommended ΓÇö capacity stocks |
| CRM / Sales | Anvil (coordinator) | CRM agent | ≡ƒƒí | Recommended ΓÇö trust, pipeline stocks |
| Marketing | Anvil (coordinator) | Marketing/growth agent | ≡ƒƒóΓÇô≡ƒƒí | Recommended ΓÇö brand equity stock |
| Procurement | Anvil (coordinator) | Procurement agent | ≡ƒƒí | Recommended ΓÇö supply stocks |
| Production / Project Mgmt | Anvil (coordinator) | PM orchestration agent | ≡ƒƒí | Recommended ΓÇö backlog stocks |
| Workflow Automation | Anvil | Workflow agent | ≡ƒƒí | Recommended ΓÇö throughput flows |
