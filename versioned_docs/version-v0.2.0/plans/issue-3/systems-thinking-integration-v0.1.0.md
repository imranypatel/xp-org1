# Systems Thinking Integration ΓÇö Versioned Plan
...
**Reinforcing loop (R1)**: Governance clarity ΓåÆ faster issue resolution ΓåÆ more issues documented ΓåÆ richer knowledge ΓåÆ better governance  
**Balancing loop (B1)**: Growing complexity ΓåÆ overhead per issue ΓåÆ resolution slowdown ΓåÆ pressure to simplify  
**Delay**: Benefits of ST investment are felt weeks/months later ΓÇö risk of premature abandonment if results aren't visible immediately  
**Archetype**: *Shifting the Burden* risk ΓÇö if ST is treated as overhead rather than essential analysis, teams will shift burden to quick-fix interventions and bypass structural insight  
**Leverage Point**: This intervention is **Meadows level 2** (paradigm/mindset) ΓÇö near-highest leverage. Changing *how problems are seen* affects every subsequent decision.
...
| `docs/standards/agent-orchestration.md` | Add ST as cross-cutting layer; update domainΓåÆagent table | v0.2.0 |
...
| ST labels ΓÇö required vs optional | Optional auxiliary | Not every issue has a clear ST angle; forcing it adds noise on simple tasks |
| ST Analysis in assessment | Required for ≡ƒö┤-risk; recommended for ≡ƒƒí; optional for ≡ƒƒó | Proportional effort |
...
- [x] `docs/standards/systems-thinking.md` created ΓÇö stocks, flows, loops, delays, archetypes, leverage points, CLD guide
- [x] `docs/models/README.md` created ΓÇö naming, format, when to model
- [x] 7 `st/` labels created in GitHub repo
- [x] `st/leverage-point` assigned to Issue #3
- [x] `domain-labels.md` updated with `st/` section (ΓåÆ v0.2.0)
- [x] `issue-workflow.md` updated with ST Analysis template (ΓåÆ v0.2.0)
- [x] `agent-orchestration.md` updated with ST cross-cutting layer + updated domain table (ΓåÆ v0.2.0)
- [x] `README.md` updated with Foundational Approach section
- [ ] PR raised: `feature/3-systems-thinking-integration` ΓåÆ `main`, `Closes #3`
- [ ] PR merged
- [ ] Tagged `v0.2.0`
...
- [Standards: Systems Thinking](../../standards/systems-thinking.md) ΓÇö Full ST reference
- [Models](../../models/README.md) ΓÇö Model directory guide
- [Standards: Domain Labels](../../standards/domain-labels.md) ΓÇö Label taxonomy including `st/`
- [Standards: Issue Workflow](../../standards/issue-workflow.md) ΓÇö ST Analysis section in assessment template
- [Standards: Agent Orchestration](../../standards/agent-orchestration.md) ΓÇö ST cross-cutting layer
